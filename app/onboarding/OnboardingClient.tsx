...
export function OnboardingClient({
  ...
  function handleSubmit() {
    ...
    startTransition(async () => {
      ...
      // New user — attempt 2 after brief delay
    ...
    <div className="bqt-screen" style={{ justifyContent: "space-between" }}>
      ...
      >
        ...
        {!isNewUser && (
          <button
            ...
            aria-label="Close"
          >
            <Icon name="close" size={22} color="var(--ink-muted)" />
          </button>
        )}
          ...
          {Array.from({ length: TOTAL_STEPS }).map((_, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: 4,
                background:
                  i === step ? "var(--saffron-500)" : "var(--hairline)",
        ...
        {isSlide && current ? (
          ...
          >
            ...
            {saveError && (
              ...
              >
                {isNewUser
                  ? "Couldn’t save — your info is cached. Tap “Try again” or reopen the app."
      ...
      >
        {isSlide ? (
          ...
          >
            {isPending ? "Saving…" : saveError ? "Try again" : "Get started"}
