...
export function SettingsClient({ bookLabel, bookName }: Props) {
  ...
  return (
    <div className="bqt-screen">
      ...
      <div className="screen-scroll" style={{ padding: "0 22px 22px", position: "relative", zIndex: 1 }}>
        ...
        <div className="card" style={{ padding: 18, marginBottom: 22, display: "flex", alignItems: "center", gap: 14 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 12, color: "var(--ink-muted)" }}>{bookLabel} · KJV · Spaced repetition</div>
          </div>
        </div>
        ...
        <div style={{ marginBottom: 22 }}>
          ...
          <div className="card" style={{ overflow: "hidden" }}>
            ...
            {/* Chapters in scope (read-only, DB-derived) */}
            <div style={{ padding: "14px 16px", display: "flex", alignItems: "center", gap: 12 }}>
              ...
              <span style={{ fontSize: 13, color: "var(--ink-muted)" }}>{bookLabel}</span>
            </div>
          </div>
        </div>
      ...
      <BottomNav active="settings" bookName={bookName} />
    </div>
  );
}
